...
<img src='https://github.com/rafagcamargo/InstagramPhotoViewer/blob/master/InstagramPhotoViewer.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Assets for me was the most difficult part, you have to research, check size, color. It is so much better when the designer give them for us developers.
